...
export const IconRocket = (p: P) => (<S {...p}><path d="M14.5 9.5 9 15c-.6 1.7-1.3 3-4 4 1-2.7 2.3-3.4 4-4l5.5-5.5z" /><path d="M12 15 9 12c1-4 3.5-8 9-9 1 5.5-3 8-9 9z" /><circle cx="14.5" cy="9.5" r="1.3" /></S>)
/* `IconHelp` (interrogação) e `IconInfo` (letra "i") são parecidos de propósito
   — mas não intercambiáveis. `IconInfo` explica um campo do formulário ali
   mesmo (FieldHint, fase-1); `IconHelp` leva à Central de Ajuda, que responde
   "como eu faço X". Trocar um pelo outro faria o usuário esperar a coisa
   errada de cada um. */
export const IconHelp = (p: P) => (<S {...p}><circle cx="12" cy="12" r="9" /><path d="M9.6 9.3a2.5 2.5 0 0 1 4.8.9c0 1.7-2.4 2.1-2.4 3.6M12 17.5h.01" /></S>)
export const IconChat = (p: P) => (<S {...p}><path d="M21 11.5a8 8 0 0 1-11.6 7.1L3 20.5l1.9-6.4A8 8 0 1 1 21 11.5z" /></S>)
