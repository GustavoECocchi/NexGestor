...
| Rota | Método | Códigos |
|---|---|---|
| `/api/v1/campaign/analyze` | POST | 200 · 400 (validação de domínio) · 422 (payload) · 500 |
| `/api/v1/campaign/scenarios` | GET | 200 (catálogo dos 15) |
| `/api/v1/campaign/health` | GET | 200 (oculto do Swagger) |
| `/api/v1/status` | GET | 200 — capacidades ligadas (IA, persistência) |
| `/` | GET | 200 (health check) |
| `/api/v1/campaigns` | GET | 200 · **501** (persistência desligada) · 500 |
| `/api/v1/campaigns` | POST | 200 · 501 · **413** (payload) · **507** (base cheia) · 500 |
| `/api/v1/campaigns/{id}` | DELETE | 200 · 501 · **404** · 500 |
