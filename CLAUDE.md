...
> **Próximo passo sugerido para a próxima sessão:** com a UI, o tema e a IA fechados, resta uma frente candidata clara: **testar a coleta automática contra um Ads Manager real** assim que houver conta disponível — é a peça mais frágil do produto e a única nunca testada de verdade. Só depois disso faz sentido mexer em persistência (item 7) ou na Meta Marketing API. Ao usar a IA nas próximas sessões, lembrar do limite de R$15 configurado na key e ser econômico com chamadas reais de teste.
